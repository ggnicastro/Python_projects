...
class Align(wx.Panel):
    def __init__(self, parent):
        wx.Panel.__init__(self, parent)
        ###Start functions here###
        t = wx.StaticText(self, -1, "This is a 2 object", (20,20))
        self.SetBackgroundColour((76,217,100))

class Anal(wx.Panel):
    def __init__(self, parent):
        wx.Panel.__init__(self, parent)
        ###Start functions here###
        t = wx.StaticText(self, -1, "This is a 3 object", (20,20))
        self.SetBackgroundColour((255,255,51))
...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        nb.AddPage(tab1, "Page 1")
        nb.AddPage(tab2, "Page 2")
        nb.AddPage(tab3, "Page 3")
